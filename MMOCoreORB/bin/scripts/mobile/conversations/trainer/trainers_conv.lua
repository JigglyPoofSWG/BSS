...
--createTrainerConversationTemplate("trainer_frslight", "force_rank_light_master", "trainer_frslight_convotemplate")
--createTrainerConversationTemplate("trainer_frsdark", "force_rank_dark_master", "trainer_frsdark_convotemplate")
