global_hard = {
	...
	lairSpawns = {
		...
		{
			lairTemplateName = "global_light_jedi_camp_light_jedi_theater",
			spawnLimit = 3,
			minDifficulty = 261,
			maxDifficulty = 270,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "global_light_master_neutral_none",
			spawnLimit = 2,
			minDifficulty = 287,
			maxDifficulty = 296,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "global_light_knight_neutral_none",
			spawnLimit = 2,
			minDifficulty = 287,
			maxDifficulty = 296,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "global_light_padawan_neutral_none",
			spawnLimit = 2,
			minDifficulty = 287,
			maxDifficulty = 296,
			numberToSpawn = 0,
