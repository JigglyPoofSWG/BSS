...
object_tangible_wearables_armor_marine_shared_armor_marine_bicep_l_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_bicep_l_gcw_f.sat",
	arrangementDescriptorFilename = "abstract/slot/arrangement/wearables/bicep_l.iff",
	...
	detailedDescription = "@wearables_detail:armor_marine_bicep_l_gcw",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_bicep_l_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_bicep_l_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_bicep_r_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_bicep_r_gcw_f.sat",
	arrangementDescriptorFilename = "abstract/slot/arrangement/wearables/bicep_r.iff",
	...
	detailedDescription = "@wearables_detail:armor_marine_bicep_r_gcw",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_bicep_r_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_bicep_r_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_boots_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_boots_gcw_f.sat",
	arrangementDescriptorFilename = "abstract/slot/arrangement/wearables/shoe.iff",
	...
	detailedDescription = "@wearables_detail:armor_marine_boots_gcw",

	gameObjectType = 263,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_boots_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_boots_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_bracer_l_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_bracer_l_gcw_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_marine_bracer_l_gcw",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_bracer_l_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_bracer_l_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_bracer_r_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_bracer_r_gcw_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_marine_bracer_r_gcw",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_bracer_r_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_bracer_r_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_chest_plate_gcw = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/armor/marine/shared_armor_marine_chest_plate_gcw.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_chest_plate_rebel_gcw_gcw_f.sat",
	arrangementDescriptorFilename = "abstract/slot/arrangement/wearables/vest.iff",
	...
	detailedDescription = "@wearables_detail:armor_marine_chest_plate_rebel_gcw_gcw",

	gameObjectType = 257,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_chest_plate_rebel_gcw_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_chest_plate_rebel_gcw_gcw",
	onlyVisibleInTools = 0,
...
ObjectTemplates:addClientTemplate(object_tangible_wearables_armor_marine_shared_armor_marine_chest_plate_gcw, "object/tangible/wearables/armor/marine/shared_armor_marine_chest_plate_gcw.iff")
...
object_tangible_wearables_armor_marine_shared_armor_marine_chest_plate_rebel_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_chest_plate_rebel_gcw_f.sat",
	arrangementDescriptorFilename = "abstract/slot/arrangement/wearables/vest.iff",
	...
	detailedDescription = "@wearables_detail:armor_marine_chest_plate_rebel_gcw",

	gameObjectType = 257,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_chest_plate_rebel_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_chest_plate_rebel_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_gloves_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_gloves_gcw_m.sat",
	...
	detailedDescription = "@wearables_detail:armor_marine_gloves_gcw",

	gameObjectType = 262,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_gloves_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_gloves_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_helmet_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_helmet_gcw_f.sat",
	arrangementDescriptorFilename = "abstract/slot/arrangement/wearables/helmet_closed_full.iff",
	...
	detailedDescription = "@wearables_detail:armor_marine_helmet_gcw",

	gameObjectType = 258,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_helmet_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_helmet_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_leggings_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_leggings_gcw_f.sat",
	arrangementDescriptorFilename = "abstract/slot/arrangement/wearables/skirt.iff",
	...
	detailedDescription = "@wearables_detail:armor_marine_leggings_gcw",

	gameObjectType = 260,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_leggings_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_leggings_gcw",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_marine_shared_armor_marine_belt_gcw = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_marine_belt_gcw_m.sat",
	...
	detailedDescription = "@wearables_detail:armor_marine_belt_gcw",

	gameObjectType = 259,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_marine_belt_gcw",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_marine_belt_gcw",
	onlyVisibleInTools = 0,
