...
function villageSarguilloPhase1ConvoHandler:runScreenHandlers(conversationTemplate, conversingPlayer, conversingNPC, selectedOption, conversationScreen)
	...
	elseif (screenID == "intro_completedfirstset") then
		...
		VillageJediManagerCommon.unlockBranch(conversingPlayer, "force_sensitive_combat_prowess_ranged_speed")
		VillageJediManagerCommon.unlockBranch(conversingPlayer, "force_sensitive_combat_prowess_melee_speed")
		VillageJediManagerCommon.unlockBranch(conversingPlayer, "force_sensitive_combat_prowess_melee_accuracy")
		FsPatrol:completeFsPatrol(conversingPlayer)
