...
function FsReflex1:completeVillagerEscort(pCreature)
	...
	if (count == 5) then
		...
		VillageJediManagerCommon.unlockBranch(pCreature, "force_sensitive_enhanced_reflexes_ranged_defense")
		VillageJediManagerCommon.unlockBranch(pCreature, "force_sensitive_enhanced_reflexes_melee_defense")
		VillageJediManagerCommon.unlockBranch(pCreature, "force_sensitive_enhanced_reflexes_vehicle_control")
		VillageJediManagerCommon.unlockBranch(pCreature, "force_sensitive_crafting_mastery_assembly")
		VillageJediManagerCommon.unlockBranch(pCreature, "force_sensitive_crafting_mastery_experimentation")
		VillageJediManagerCommon.unlockBranch(pCreature, "force_sensitive_crafting_mastery_repair")
		VillageJediManagerCommon.unlockBranch(pCreature, "force_sensitive_crafting_mastery_technique")
