...
void CommandConfigManager::registerCommands() {
	...
	commandFactory.registerCommand<ForceDodgeCommand>(String("forceDodge").toLowerCase());
	commandFactory.registerCommand<ForceBarrierCommand>(String("forceBarrier").toLowerCase());
	commandFactory.registerCommand<ForceFocusCommand>(String("forceFocus").toLowerCase());
	commandFactory.registerCommand<ForceFocusCommand>(String("forceInfusion").toLowerCase());
